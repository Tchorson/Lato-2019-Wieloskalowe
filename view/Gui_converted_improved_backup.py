...
class Ui_Dialog(QWidget):
    ...
    def setupUi(self, Dialog):
        ...
        self.graphic_ca_1d.setMinimumSize(QtCore.QSize(720, 350))
        self.graphic_ca_1d.setMaximumSize(QtCore.QSize(720, 350))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.OneDimensionalTab), _translate("Dialog", "OneDimensional"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.TwoDimensionalTab), _translate("Dialog", "TwoDimensional"))
    ...
    def begin_game(self):
        ...
        while counter >0:
            ...
            for index in range(len(self.current_iteration_array)):
                rectangle = QtCore.QRectF(QtCore.QPointF(index * side, row * side), QtCore.QSizeF(side, side))
                if self.current_iteration_array[index].is_alive == True:
                    self.scene_1d.addRect(rectangle, self.red_pen)
                else:
                    self.scene_1d.addRect(rectangle,self.green_pen)
